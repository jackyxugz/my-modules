...
class LxbCourse(models.Model):
    ...
    serve_type = fields.Selection([('bycourse', '按照机构排课'), ('byappoint', '学生约课')], '上课方式', default='bycourse',
                                  required=True)
    pay_type = fields.Selection([('payfirst', '预付费'), ('ontime', '随学随付'), ('other', '其他')], '付费方式', default='payfirst',
                                required=True)
